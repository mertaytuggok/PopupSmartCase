  ...
  return (
    <div>
      ...
      <div className="mt-[30px]  flex flex-row justify-center">
        ...
        <button
          onClick={() => setModalName("CheckMailModal")}
          className="relative  hover:bg-violet-400 w-[276px] h-[200px]  bg-[#EAEAEA] border-4 rounded-xl mr-[30px]  "
        >
      ...
      <div className=" mt-[30px] flex flex-row justify-center">
        ...
        <button
          onClick={() => setModalName("Reminders")}
          className="relative  hover:bg-violet-400 w-[276px] h-[200px]  bg-[#EAEAEA] border-4 rounded-xl mr-[30px]  "
        >
      ...
      <div className=" mt-[30px]  flex flex-row  ">
        <div className=" ml-16  bg-[#F5F5F5] rounded-xl  justify-center text-center ">
          {["1", "2", "3"].map((item) => (
            <button className=" w-[40px] h-[40px]   hover:bg-white ">
              {item}
            </button>
          ))}
        </div>
