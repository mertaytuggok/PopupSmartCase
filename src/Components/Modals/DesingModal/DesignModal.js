...
export const DesignModal = () => {
    return (
        ...
        <div className='mb-[40px] w-full h-[60px] bg-white grid justify-items-center'> <HeyThere /> </div>
            ...
            <div className=' absolute top-[83px] right-[23px] '><CgCloseO size={30} color="gray" /></div>
        </div>
        </>
    )
}
