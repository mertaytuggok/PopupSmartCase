    ...
    <div className=" relative   w-[480px] h-[507px]  grid justify-items-center rounded-lg  ">
      ...
      <div className=" flex flex-row ">
        ...
        <input
          ...
          className=" w-[236px] h-[47px] border-2 rounded-md p-3 "
        />
      </div>

      <button className=" bg-[#7D4AEA] ml-[15px] text-white font-medium w-[168px] h-[48px] text-[16px] border-2 rounded-md ">
        Sign up
      </button>
      <div className=" flex flex-row space-x-20">
        <button className="     font-normal w-[135px] h-[19px] text-[16px]  ">
          I have an account
        </button>
        <button className="   font-normal w-[135px] h-[19px] text-[16px]  ">
          Forgot Password
